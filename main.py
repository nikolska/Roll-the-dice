...
def roll_the_dice(data):
    '''
    Function roll_the_dice takes a string, recognizes the type of dice, number of rolls,
    modifier, and if the given string is incorrect, it will return the appropriate message,
    otherwise it will simulate the rolls and return the result.
    :data type: string
    :return: result of the dice roll if data is correct, or error-message if not.
    '''
